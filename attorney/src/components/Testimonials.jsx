  ...
  const testimonials = [
    {
      name: 'Sarah Mohlala',
      role: 'Business Owner',
      text: 'Matshaya M. T Attorneys provided exceptional legal guidance for my business. Their professionalism and expertise gave me the confidence I needed.',
    },
    {
      name: 'John Malope',
      role: 'Private Client',
      text: 'I was facing a difficult family law matter, and the team handled my case with compassion and skill. I am grateful for their support.',
    },
    {
      name: 'Grace Nkuna',
