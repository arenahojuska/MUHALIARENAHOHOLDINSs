      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-white font-bold text-lg">Matshaya M. T Attorneys</h3>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Professional legal services you can trust. Serving Polokwane with dedication and excellence.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-400">
                  93 Schoeman Street, VS Building, Office No H2, Polokwane
                </span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="w-5 h-5 text-amber-500 flex-shrink-0" />
                <a href="tel:0762239306" className="text-gray-400 hover:text-amber-500 transition-colors">
                  076 223 9306
                </a>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="text-center text-gray-400">
            <p>&copy; {currentYear} Matshaya M. T Attorneys. All rights reserved.</p>
            <p className="mt-2 text-sm">Professional Legal Services in Polokwane</p>
          </div>
        </div>
      </div>
    </footer>
