            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Thohoyandou , Rustenburg , Roodeport</p>
                  <p className="text-gray-700"> Limpopo</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:0813224164" className="text-gray-700 hover:text-amber-500 transition-colors">
                    +27813224164 +27674967148
                  </a>
                </div>
              </div>
