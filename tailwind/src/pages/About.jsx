        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h3 className="text-3xl font-bold text-slate-900 mb-6">
              Trusted Legal Partners in Thohoyandou, Roodepoort , Rustenburg
            </h3>
            <p className="text-gray-700 text-lg mb-4 leading-relaxed">
              Tshikhakhisa Attorneys is a reputable law firm dedicated to providing expert legal services to individuals and businesses across Gauteng , Limpopo and beyond. With years of experience and a commitment to excellence, we have built a strong reputation for delivering results.
            </p>
            <p className="text-gray-700 text-lg mb-4 leading-relaxed">
